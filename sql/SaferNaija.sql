...
CREATE TABLE `ad_lists` (
  ...
  `hide_contact` int(11) NOT NULL DEFAULT 0,
  `contact_num` varchar(60) NOT NULL,
  `featured` int(11) NOT NULL DEFAULT 0,
  `expired_date` date DEFAULT NULL,
  `type` int(11) NOT NULL COMMENT '1 = sell , 2 = rent',
  `use_condition` int(11) NOT NULL COMMENT '1 = ''new'', 2 = ''used''',
...
CREATE TABLE `ad_promotes` (
  ...
  `status` int(11) NOT NULL COMMENT '1 = accepted, 0 = pending, 2 = rejected\r\n',
  `running` int(11) NOT NULL DEFAULT 0 COMMENT '1 = running, 0 = ''not running''',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `general_settings` (
  ...
  `promote_approval` int(11) NOT NULL DEFAULT 0 COMMENT '0 = no need for approval, 1 = need approval',
...
CREATE TABLE `report_ads` (
  ...
  `seen` int(11) NOT NULL DEFAULT 0 COMMENT '1 = seen , 0 = not seen yet',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `support_messages` (
  `id` int(10) UNSIGNED NOT NULL,
  `support_ticket_id` int(11) NOT NULL DEFAULT 0,
...
ALTER TABLE `certificates`
  ...
  ADD KEY `idx_vin_number` (`vin_number`),
  ADD KEY `idx_serial_number` (`serial_number`),
  ADD KEY `idx_post_id` (`post_id`),
  ADD KEY `idx_device_identifier` (`device_identifier`),
